...
class nnUNetTrainer_fullyefficient_v2_l(nnUNetTrainerV2):
    ...
    def initialize_network(self, training=True):
        ...
        self.network = Fullyefficient_UNet_v2(self.num_input_channels, self.base_num_features, self.num_classes,
                                    ...
                                    self.net_num_pool_op_kernel_sizes, self.net_conv_kernel_sizes, False, True, True, eff_netv2=effnetv2_l3d(override_last_stride=self.net_num_pool_op_kernel_sizes[-1], num_inp_channels=self.num_input_channels))
