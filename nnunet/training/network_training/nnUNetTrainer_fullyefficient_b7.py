...
class nnUNetTrainer_fullyefficient_b7(nnUNetTrainerV2):
    ...
    def initialize_network(self, training=True):
        ...
        self.network = Fully_Efficient_UNet(self.num_input_channels, self.base_num_features, self.num_classes,
                                    ...
                                    self.net_num_pool_op_kernel_sizes, self.net_conv_kernel_sizes, False, True, True, efficient_model="efficientnet-b7", patch_size = self.patch_size)
