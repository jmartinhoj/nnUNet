...
from nnunet.training.loss_functions.combined_loss import CombinedLoss
...
class nnUNetTrainer_fullyefficient_b7_VAE_lr3(nnUNetTrainerV2):
    """
    ...
    def initialize(self, training=True, force_load_plans=False):
        ...
        if training:
            self.combined_loss = CombinedLoss(self.loss)
        return a
    ...
    def initialize_network(self, training):
        ...
        self.network = Fully_Efficient_UNet(self.num_input_channels, self.base_num_features, self.num_classes,
                                    ...
                                    self.net_num_pool_op_kernel_sizes, self.net_conv_kernel_sizes, False, True, True, efficient_model="efficientnet-b7", patch_size = self.patch_size, use_VAE = training)
